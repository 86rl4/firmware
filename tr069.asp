...
/*****************************************************************************
* Function Name : initTranslation
  * Function: Get the page element display name from the configuration file
  * Input parameters: none
  * Output parameters: None
  * Return Value : None
  * Others:
  * Record
  * 1. Date: March 21, 2011
  * Author: Wu Xiaojuan
  * Modified content: New generation function
...
/*modify by ChenPeng 20180709  Reason: HG6245D Thailand 3BB customized version requires verification code(not use letter"O","I"(i upper case),"l"(L lower case) and number"0","1")*/
...
* Function Name : CheckValue
  * Function: Verify the legality of page input parameters
  * Input parameters :field: page object
  * Output parameter : boolean: is it legal?
...
<form method=post name="fm_tr069_basic" action="/goform/setTR069Basic_3BB" onsubmit="return CheckValue()">
  <table class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%">
    <tbody>
       <!--tr>
        <td class="tabal_left" id="tr069Enable_title" align="left" width="25%"></td>
      ...
      <tr>
        <td colspan="2"><input type="checkbox" checked="checked" id="tr069authCheckbox" onclick="clickAuthCheck();"/><span id="tr069auth_Title"></span></td>
      </tr>
      <tr>
  ...
  <table class="tabal_button" border="0" cellpadding="0" cellspacing="1" width="100%">
    <tbody>
      <tr>
        ...
        <td class="tabal_submit" width="35%" align="left"><input class="submit" type="submit" id="tr069BasicApply">
          &nbsp; &nbsp;
